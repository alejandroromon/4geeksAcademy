...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.lastname == null ? "Lastname" : variables.lastname
          ...
          <h2>${
            variables.role == null ? "Adiestrador de ponys" : variables.role
          }</h2>
          <h3>${variables.country == null ? "Andalucía" : variables.country} ${
    variables.city == null ? "Guarromán" : variables.city
  }</h3>
